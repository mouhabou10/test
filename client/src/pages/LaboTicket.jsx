      ...
      {showTicketOption ? (
        <div className="ticket-booking-container">
          <div className="ticket-header">
            <h1>Laboratory Appointment Ticket</h1>
          ...
          <div className="ticket-booking-content">
            <div className="ticket-status accepted">
              ...
              <div className="status-text">
                ...
                <p>Your laboratory appointment request has been approved!</p>
              </div>
            </div>
            ...
            <div className="ticket-booking-info">
              ...
              <p>
                You can now book a ticket for your laboratory appointment. This will allow you to
            ...
            <div className="ticket-note">
              ...
              <ul className="note-content">
                ...
                <li>The laboratory department is located on the 1st floor</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="request-confirmation-container">
          ...
          <div className="confirmation-content">
            ...
            <div className="confirmation-message">
              <p>
                Your laboratory prescription has been successfully uploaded. Our medical team will review 
